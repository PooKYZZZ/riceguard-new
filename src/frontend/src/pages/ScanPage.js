// src/pages/ScanPage.js - Optimized Version
...
function ScanPage() {
  ...
  // Memoized recommendations to avoid recreation on every render
  ...
  // Image select + preview - optimized with useCallback
  ...
  // Upload + inference - optimized with useCallback
  ...
  }, [image, token, recommendations]);

  const handleHistory = useCallback(() => navigate("/history"), [navigate]);
  ...
  // Profile panel functions - optimized with useCallback
